          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm sm:text-base">
                    ...
                    {language === "mr" ? "+९८६०३७९३५६" : "+91-9860379356"}
                  </p>
                </div>
              </div>
            </div>
                ...
                <div>
                  ...
                  <p className="text-gray-700 text-sm sm:text-base">
                    ...
                    <span className="text-red-500 font-semibold">
                      {language === "mr"
                        ? "सकाळी ०९.४५ ते संध्याकाळी ६.१५"
                        : "09:45 AM to 06:15 PM"}
                    </span>
                  </p>
                </div>
              </div>
            ...
            {/* <div className="bg-white rounded-lg shadow-lg p-6">
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.facebook.com/share/1APdoDbsJ4/"
                ...
                <a
                  href="https://www.instagram.com/gotkhindi123?igsh=MWJyZmRibmNjZGtlZg=="
          ...
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="w-full aspect-[3/2] bg-gray-200 relative overflow-hidden">
              <iframe
                ...
                height="800"
                id="gmap_canvas"
                src="https://maps.google.co.in/maps?f=q&amp;source=s_q&amp;hl=en&amp;geocode=&amp;q=Kapuskhed+Walwa+Sangli+Maharashtra&amp;t=h&amp;ie=UTF8&amp;hq=Kapuskhed&amp;hnear=Walwa+Sangli+Maharashtra&amp;output=embed&amp;iwloc=near"
              ></iframe>
            </div>
          </div>
        </div>
